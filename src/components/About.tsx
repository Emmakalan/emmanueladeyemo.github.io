...
import northAmericaIcon from '../assets/north-america.png';
import asiaIcon from '../assets/asia (1).png';
              ...
              {globalReach.map((region, index) => (
                ...
                >
                  <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6 hover:bg-white/10 hover:border-[#6B8CFF]/50 hover:shadow-xl hover:shadow-indigo-500/10 hover:-translate-x-2 transition-all duration-300 group">
                    <div className="flex items-start gap-4">
                      <div className={`w-12 h-12 rounded-full bg-gradient-to-br ${region.color} flex items-center justify-center flex-shrink-0 group-hover:shadow-lg group-hover:shadow-indigo-500/50 transition-all overflow-hidden`}>
                        <img 
                          src={region.icon} 
                          alt={`${region.continent} icon`}
