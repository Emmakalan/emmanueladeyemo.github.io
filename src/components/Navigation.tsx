...
export function Navigation() {
  ...
  const navItems = [
    ...
    { label: 'Approach', href: '#approach', icon: Lightbulb },
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between relative">
          {/* Logo */}
          <a href="#home" className="group z-20 relative">
            <img 
              src={emmanuelLogo} 
              alt="Emmanuel Adeyemo Logo" 
              className="w-20 h-12 sm:w-40 sm:h-24 object-cover group-hover:scale-110 transition-transform duration-300 filter brightness-0 invert"
            />
          </a>
